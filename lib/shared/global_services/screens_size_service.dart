...
class ScreenSizeService {
  ...
  /// Singleton that provides the current screen size: Screensize.largeScreen / normalScreen / smallScreen.
  ScreenSize screenSizeServiceNew({required MediaQueryData mediaQuery}) {
    if (_screenSize == null) {
      final double aspectRatioCustom = mediaQuery.size.height / mediaQuery.size.width;
